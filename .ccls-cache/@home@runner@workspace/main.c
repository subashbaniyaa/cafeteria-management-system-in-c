    ...
    struct OrderQueueNode* createOrderQueueNode(struct OrderItem* data)
    {
    ...
    int isOrderQueueEmpty(struct OrderQueueNode** orderQueue)
    {
    ...
    a:
        ...
        do
        {
            ...
            if (isAuthenticated)
            {
                do
                {
                    printf("\nCafeteria Management System (Admin Mode)\n");
                    ...
                    case 3:
                        ...
                        break;
                            ...
                            case 10:
                                saveMenuToFile(menu);
                                isAuthenticated = 0; // Exit admin mode
                                break;
                            default:
